local musicPlayer = require "music.music_player"
...
function musicSystem:playAllPlayer(key)
  for _, player in pairs(self.players) do
    if not player:nowPlaying(key) then player:play(key) end
  end
end
...
function musicSystem:controlChangeAllPlayer(controlType, value)
